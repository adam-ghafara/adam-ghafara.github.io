...
import {overlay,map,popupinfo,idmarker} from '../config/map.js';
...
export function onSubmitMarkerClick() {
    ...
    postWithToken("https://us-central1-gis-tester-401506.cloudfunctions.net/let-load","PASETOPUBLIC","1329470RFYUN89HUDSKLSDMZX",data,afterSubmitCOG);
    overlay.setPosition(undefined);
    textBlur('popup-closer');
